    ...
    social: [
      {
        name: 'Facebook',
        icon: (props) => (
          <a href="https://www.facebook.com/profile.php?id=61560429093460" target="_blank">
      ...
      { 
        name: 'Linkedin',   
        // href: 'https://www.linkedin.com/in/shasam-centro-terap%C3%A9utico-online-a07863300/',  
        icon: (props) => (
          <a href="https://www.linkedin.com/in/shasam-centro-terap%C3%A9utico-online-a07863300/" target="_blank">
          <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
