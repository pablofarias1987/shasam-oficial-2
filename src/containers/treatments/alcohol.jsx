...
const NAME1 ="El alcoholismo, un riesgo para la salud";
const parrafo3 ="El consumo de alcohol moderado no es un problema de salud crítico, el riesgo se produce al cruzar la delgada línea entre un consumo social y un consumo severo que cause dependencia (adicción), los alcohólicos consumen en exceso, frecuentemente y de forma prolongada el alcohol.";
const NAME2 = "El alcohol, un problema de salud"
const parrafo4 ="El alcoholismo es una enfermedad crónica donde el alcohólico no controla el impulso de ingesta de bebidas alcohólicas, afectando su salud física, mental, economía, relaciones familiares e interacción social. Por estas razones es vital que el paciente se centre y ponga empeño en dejar el alcohol con ayuda profesional, como la que brindamos en Shasam a través de nuestra terapia alcoholismo online.";
const parrafo5 ="El trastorno por consumo adictivo de alcohol produce: Ansiedad, irritabilidad, pérdida de control, cambios bruscos emocionales…";
const parrafo6 ="Las causas por las cuales una persona tiende a consumir alcohol son diversas, algunas de ellas incluyen: Aceptación social, por diversión, para vencer la timidez, efectos de bienestar, escape emocional de los problemas, étc.";
const parrafo7 ="Para aprender las estrategias sobre cómo dejar de beber, es importante que el paciente acepte que padece un problema de alcoholismo.";
const parrafo8 ="Existen factores de riesgos que contribuyen al desarrollo de la adicción al alcohol, entre los cuales se encuentran: Antecedentes familiares, inicio de consumo de alcohol a temprana edad, factores psicológicos (baja autoestima, depresión, ansiedad) y factores sociales (conflictos de pareja, desempleo, presión social).";
const parrafo9 ="Al año, se producen más de tres millones de muertes a nivel mundial producto de la ingesta de alcohol, cifras aportadas por la OMS, siendo éste un motivo de peso para que las personas alcohólicas busquen ayuda para dejar de beber alcohol.";
const parrafo10 ="Las consecuencias nocivas para la salud que produce el alcohol en las personas que tienen problemas con el alcohol se pueden clasificar en:";
const titulo1 ="1.- Físicas";
const parrafo12 ="Cáncer, cirrosis, enfermedades del hígado, hipertensión, diabetes, insomnio, gastritis, problemas cardiovasculares, pancreatitis, déficit nutricional, apoplejía, degeneración cerebral, envejecimiento prematuro, coma, muerte, epilepsia, disfunción eréctil, étc.";
const titulo2 ="2.- Psicológicas";
const parrafo13 ="Ansiedad, depresión, celopatía, demencia, psicosis, agresividad, ira, falta de concentración, pérdida de la memoria, étc.";
const titulo3 ="3.- Sociales";
const parrafo14 ="Problemas de interacción social, problemas familiares, maltrato, agresiones sexuales, suicidio, étc.";



const parrafo15 ="El tratamiento del alcoholismo es un trabajo en equipo, donde intervienen especialistas y familiares y entorno cercano del paciente. El consumo de alcohol de forma incontrolada, puede estar determinado por la personalidad de la persona, el ambiente socio-cultural, accesibilidad y permisividad al consumo de bebidas alcohólicas.";
